...
exports.logout = exports.login = exports.sendOTP = void 0;
...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(otp, email) {
    var res;
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                if (res.data.data.user.role === 'user') location.assign('/user');else {
...
},{"axios":"../../node_modules/axios/index.js"}],"updateResume.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadUser = exports.updateResume = void 0;
...
var updateResume = /*#__PURE__*/function () {
  ...
  return function updateResume(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var uploadUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(jobId) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "/api/v1/jobs/applyJob/".concat(jobId);
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  return function uploadUser(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.uploadUser = uploadUser;
},{"axios":"../../node_modules/axios/index.js"}],"profileForm.js":[function(require,module,exports) {
"use strict";
...
var profileForm = /*#__PURE__*/function () {
...
},{"axios":"../../node_modules/axios/index.js"}],"employerJob.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.employerJob = void 0;
...
var employerJob = /*#__PURE__*/function () {
  ...
  return function employerJob(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.employerJob = employerJob;
},{"axios":"../../node_modules/axios/index.js"}],"updateMe.js":[function(require,module,exports) {
"use strict";
...
var _employerJob = require("./employerJob");

var _updateMe = require("./updateMe");

// DOM ELEMENTS
var sendOTPBtn = document.querySelector('.send__otp');
var loginBtn = document.querySelector('.submit__login'); // const jobForm = document.querySelector('.job__form');

var resumeApply = document.querySelectorAll('.resume__apply');
var profileButton = document.querySelector('.nav__btn--1');
var logoutButton = document.querySelector('.nav__btn--2');
var CreateJobForm = document.querySelector('.employer__submit');
var profileField = document.querySelector('.profile__field');
...
if (loginBtn) {
  loginBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var otp = document.querySelector('.otp__input').value;
    var email = document.getElementById('email').value;
...
if (profileButton) {
  profileButton.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _profileForm.profileForm)();
  });
}

if (resumeApply) {
  resumeApply.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      var form = new FormData();
      var jobId = el.closest('.job').dataset.jobId;
      ...
      (0, _updateResume.uploadUser)(jobId);
      (0, _updateResume.updateResume)(form);
    });
  });
} // if (CreateJobForm) {
