...
exports.login = exports.sendOTP = void 0;
...
var loginBtn = document.querySelector('.submit__login');
var jobForm = document.querySelector('.job__form');
var resumeApply = document.querySelector('.resume__apply');
...
if (resumeApply) {
  resumeApply.addEventListener('click', function (e) {
